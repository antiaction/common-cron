 ...
 */
public class CrontabSchedule extends CronScheduleAbstract {
	 ...
	 */
	public boolean crontabFactory(String str) {
		CronSchedule cron = new CrontabSchedule();
		return ((CrontabSchedule)cron).parseString(str);
	}
